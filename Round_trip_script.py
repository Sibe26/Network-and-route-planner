...
Random_Seed = 0 # No random seed = 0
n = 1
StreetName = "Park Oog in Al" #If street name doesn't exist in the database, query will return empty
Wind_Direction = "km"
Outer_buffer_km = 5 #in km
Inner_buffer_km = 4 #in km
Total_waypoints = 2 #minimum 2, maximum 8, it however recommended to only use more waypoints with a large buffer
